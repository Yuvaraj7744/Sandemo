...
const Starting = () => {
  ...
  return (
    <div>
     <div className='bg-blue-500 h-40  w-screen   text-white font-serif md:flex  items-center    md:h-15 '>
   ...
   <div className="flex items-center justify-between px-10 py-4 ">
    ...
    <div className="hidden lg:flex gap-8 text-lg font-semibold text-gray-700">
   ...
   <span  onClick={handletoggle} className="text-2xl md:hidden cursor-pointer "><IoMdMenu/></span>
     ...
     <div className=" text-white bg-black fixed top-0 left-0  
     w-[320px]  max-w-[400px] h-full rounded-xl z-50 p-6 shadow-xl flex flex-col">
      <div className="flex items-center justify-between">
      <h1 className="font-serif  flex font-bold text-2xl">Sandbox</h1>
      <div className="bg-gray-700 text-white font-bold rounded-full w-7 h-7 flex items-center justify-center cursor-pointer" onClick={handletoggle}>
     ...
     <p className="mt-auto">info@emil.com</p>
     ...
     <div className="flex mt-2 gap-3">
      ...
      <div>
        <img src={about} className=" w-[400px] lg:w-[600px] h-auto rounded-2xl  md:mr-20"   />
      </div>
      ...
      <div className="grid grid-cols-3  mt-10  lg:flex md:gap-30   items-center  gap-5 ml-5  md:ml-30">
