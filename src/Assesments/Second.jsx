  ...
  return (
    <div>
        ...
        <div className='mt-5'>
          ...
          <h1 className="font-bold  ml-20 font-serif text-2xl md:text-4xl text-gray-900 leading-tight md:text-center md:mt-5 mt-10 ">The service we offer is specifically <br /> designed to meet your needs.
          </h1>
        </div>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 font-serif justify-center items-start px-8 mt-10  '>
            <div className='flex flex-col justify-center items-center  mt-10'>
                ...
                <p className='ml-5 text-gray-500 md:px-3'>Etiam port sem malesuada magna. Donec ullamcorper numma non metus auctor frungilla </p>
         ...
         <div className='flex flex-col justify-center items-center mt-10'>
                ...
                <p className='ml-5 text-gray-500'>Etiam port sem malesuada magna. Donec ullamcorper numma non metus auctor frungilla </p>
                <a href="#" className='flex items-center gap-1 text-blue-600'>Learn More <FaArrowRight /> </a>
            </div>
         <div className='flex flex-col justify-center items-center mt-10'>
