...
const Second = () => {
  return (
    <div>
        ...
        <div className=''>
          <p className="mt-4  md:ml-[40%]  text-gray-500 ml-50 md:mt-10">What we do?</p>
          <h1 className="font-bold  ml-20 font-serif text-xl md:text-4xl text-gray-900 leading-tight md:ml-[30%] md:mt-2 ">The service we offer is specifically <br /> designed to meet your needs.
          </h1>
        </div>
