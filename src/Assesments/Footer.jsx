    ...
    <div className='font-serif'>
             <div className=" ml-5 md:flex  md:justify-between  md:items-start md:px-28 md:gap-20 py-10 ">
              <div className='md:w-1/4'>
                 <img src={one} className="max-h-5  ml-5" alt="" />
            ...
            <div className='md:w-1/4'>
              <h1 className='mt-5 text-2xl md:text-4xl font-semibold text-gray-900'>Get in Touch </h1>
            ...
            <div className='md:w-1/4'>
              <h1 className='mt-4 text-2xl md:text-4xl font-semibold text-gray-900'>Learn More</h1>
            ...
            <div className='md:w-1/4'>
              <h1 className='mt-4 text-2xl md:text-4xl font-semibold text-gray-900 '>Our Newsletter</h1>
